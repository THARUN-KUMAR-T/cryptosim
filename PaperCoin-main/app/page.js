    ...
    <div className="relative h-screen w-screen overflow-x-hidden bg-black select-none">
      ...
      <nav className="absolute top-0 left-0 right-0 z-20 px-14 py-4">
        <div className="container mx-auto flex justify-between items-center">
          <div className="flex items-center">
            <span className="text-2xl font-bold text-white">CryptoSim</span>
          </div>
      ...
      <div className="flex h-screen w-full pl-6 md:pl-14 relative z-10">
        ...
        <div className="w-full md:w-1/2 h-full flex flex-col justify-center">
          ...
          <div className="mt-12 hidden md:block">
            <p className="text-gray-500 text-sm mb-3">TRUSTED BY 500+ TRADERS</p>
      ...
      <section id="features" className="bg-black py-20">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-4">
            Why Choose <span className="text-amber-500">CryptoSim</span>
          </h2>
      ...
      <section id="testimonials" className="bg-[#0F0F0F] py-20">
        <div className="container mx-auto px-6">
          ...
          <p className="text-gray-400 text-center max-w-2xl mx-auto mb-16">
            Join thousands of traders who have improved their skills using CryptoSim
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-800 p-6 rounded-xl">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-gray-700 rounded-full mr-4"></div>
                <div>
                  <h4 className="text-white font-bold">Sarah Kim</h4>
                  <p className="text-gray-500 text-sm">Trader</p>
                </div>
              </div>
              <p className="text-gray-400">
            ...
            <div className="bg-gray-800 p-6 rounded-xl">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-gray-700 rounded-full mr-4"></div>
                <div>
                  <h4 className="text-white font-bold">Mike Johnson</h4>
                  <p className="text-gray-500 text-sm">Trader</p>
                </div>
              </div>
              <p className="text-gray-400">
        ...
        <div className="border-t border-gray-800 py-6">
          <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center">
            <div className="text-sm mb-4 md:mb-0">
              &copy; {new Date().getFullYear()} CryptoSim. All rights reserved.
            </div>
